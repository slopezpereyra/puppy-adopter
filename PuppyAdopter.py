...
# We need all environment setting class to be on separated script.
...
class DataManager:
      ...
      st    oring the program's data on the data file precissed."""
...
def get_random_url(web_object, web_object_number):
  """Picks a random image from the given website and retrieves its url.
...
def look_images(pages_list, saves_list):
  ...
  There were cases of .jpg urls ending on ' 2x' and others of urls
...
if os.path.isfile(EnvironmentSetup.get_cwd('/CoolEnv')) is False:
